/*Program 2.7 Working with complex numbers */
...
int main(void)
{
 ...
 printf("Working around with complex numbers:");
 printf("\nStarting values: cx = %.2f%+.2fi cy= %0.2f%.2fi",creal(cx),cimag(cx),creal(cy),cimag(cy));
