...
int main(void)
{
 ...
 printf("\nVariables of type unsigned short store values from 0 to %d",USHRT_MAX);
 ...
 printf("\nThe size of the smallest value of type float is %.3e",FLT_MIN);
 ...
 printf("\nVariable sof type float provide %u decimal digits of precision.",FLT_DIG);
